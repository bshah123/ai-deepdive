...
## Chapter 36 Summary — ANN Algorithms (HNSW & IVF-PQ)

### What You Learned
- Core mathematical principles and architectural layout of **ANN Algorithms (HNSW & IVF-PQ)**.
...
### Before Moving On
- □ I can explain the low-level data structures and execution flow of ANN Algorithms (HNSW & IVF-PQ).
